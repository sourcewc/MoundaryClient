 ...
 */
public class PostDetailActivity extends FontActivity {
    //하드코딩 밭,, 교체해줘야 합니다
        ...
        repleInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (repleData != null && repleData.length() > 0) {
                    ...
                    Toast.makeText(PostDetailActivity.this, "입력된 값이 존재하지 않습니다.", Toast.LENGTH_SHORT).show();
    ...
    class AsyncPostDetailList extends AsyncTask<String, Integer, ArrayList<PostDetailEntityObject>> {
        NetworkDialog netwrokDialog = new NetworkDialog(PostDetailActivity.this);
        ...
        protected void onPostExecute(final ArrayList<PostDetailEntityObject> result) {
            ...
            if (result != null) {
                if (result.size() > 0) {
                    Glide.with(PostDetailActivity.this).load(result.get(0).postImg).override(510, 300).centerCrop().into(member_image);
    ...
    public class AsyncReplyInsert extends AsyncTask<ReplyEntityObject, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null && result.equalsIgnoreCase("success")) {
                ...
                Toast.makeText(PostDetailActivity.this, " 댓글 정상 입력.", Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(PostDetailActivity.this, "댓글 입력 실패.", Toast.LENGTH_SHORT).show();
            }
        }
    }
